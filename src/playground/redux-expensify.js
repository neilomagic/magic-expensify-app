...
// create seperate reducers

// Expense reducers
const expensesReducerDefeaultState = [];
// const expensesReducer = (state = expensesReducerDefeaultState, action)=>{
//     switch (action.type) {
//         case 'ADD_EXPENSE':
...
const filterReducerDefaultState = {
    text: '',
    sortBy: 'date', startDate: undefined, endDate: undefined
};
...
const getVisibleExpenses = (expenses, {text, sortBy, startDate, endDate })=>{
    return expenses.filter((expense)=>{
        ...
        //console.log(startDate,startDateMatch,endDateMatch);
...
const expenseTwo = store.dispatch(addExpense({description:'Rolex', amount:1500, createdAt: -1000}));
